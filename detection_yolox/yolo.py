...
class YOLO(object):
    _defaults = {
        ...
        #   输入图片的大小，必须为32的倍数。
        #---------------------------------------------------------------------#
        "input_shape"       : [736, 1280],  # <-- INCREASED FROM [640, 640]
        #---------------------------------------------------------------------#
    ...
    def detect_image(self, image):
        ...
        for i, c in list(enumerate(top_label)):
            ...
            out.append((x1,y1,x2,y2,predicted_class,torch.from_numpy(np.array(score)).cpu()))
